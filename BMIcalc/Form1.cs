...
namespace BMIcalc
{
    public partial class Form1 : Form
    {
        ...
        private void woman_Click(object sender, EventArgs e)
        {
            ...
            sex = "female";
            diag_pic.Image = System.Drawing.Image.FromFile("C:\\Users\\Амишка\\Documents\\24ИС МДК\\BMIcalc\\marathon-skills-2016-gender-icons\\female-icon.png");
        }
        ...
        private void rasch_Click(object sender, EventArgs e)
        {
            ...
            if (BMI < 18.5)
            {
                ...
                {
                    diag_pic.Image = System.Drawing.Image.FromFile("C:\\Users\\Амишка\\Documents\\24ИС МДК\\BMIcalc\\marathon-skills-2016-gender-icons\\bmi-underweight-icon.png");
                }
            ...
            else if (BMI < 24.9)
            {
                ...
                {
                    diag_pic.Image = System.Drawing.Image.FromFile("C:\\Users\\Амишка\\Documents\\24ИС МДК\\BMIcalc\\marathon-skills-2016-gender-icons\\male-icon.png");
                }
                trackBar.Value = Convert.ToInt32(BMI);
                diagg.Text = ("здоровый");
            }
            else if (BMI < 29.9)
            {
                ...
                {
                    diag_pic.Image = System.Drawing.Image.FromFile("C:\\Users\\Амишка\\Documents\\24ИС МДК\\BMIcalc\\marathon-skills-2016-gender-icons\\bmi-obese-icon.png");
                }
                trackBar.Value = Convert.ToInt32(BMI);
            ...
            else if (BMI > 30)
            {
                ...
                {
                    diag_pic.Image = System.Drawing.Image.FromFile("C:\\Users\\Амишка\\Documents\\24ИС МДК\\BMIcalc\\marathon-skills-2016-gender-icons\\bmi-overweight-icon.png");
                }
                trackBar.Value = Convert.ToInt32(BMI);
                diagg.Text = ("Ожирение");
            }
